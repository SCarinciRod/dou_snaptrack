...
from ..detail_utils import scrape_detail_structured, abs_url
...
class CascadeService:
    ...
    def _scrape_sequential(self, raw_items: List[Dict[str, Any]], params: CascadeParams, 
                           dedup: Optional[DedupState]) -> tuple[list, int]:
    ...
    def _fetch_detail(self, url: str, params: CascadeParams, fallback_date: Optional[str] = None):
