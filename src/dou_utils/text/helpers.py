...
def get_fallback_from_title(it: dict[str, Any]) -> str | None:
    ...
    """
    from dou_utils.bulletin.generator import _extract_doc_header_line, _final_clean_snippet
...
def apply_summarizer_with_fallbacks(
    ...
    Returns:
        Tuple of (snippet, method_tag)
    """
    from dou_utils.bulletin.generator import _remove_dou_metadata, _strip_legalese_preamble
...
def apply_default_summarizer(text: str, max_lines: int, mode: str, keywords: list[str] | None) -> str | None:
    ...
    """
    from dou_utils.bulletin.generator import _default_simple_summarizer
...
def post_process_snippet(snippet: str, max_lines: int) -> str:
    ...
    Returns:
        Cleaned snippet
    """
    from dou_utils.bulletin.generator import _cap_sentences, _final_clean_snippet
